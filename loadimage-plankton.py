...
trainPath = "D://python2.7.6//MachineLearning//pcawhiten-face//trainplankton-yr"
datafile="D://python2.7.6//MachineLearning//pcawhiten-face//dataVec.txt"
labelfile="D://python2.7.6//MachineLearning//pcawhiten-face//dataLabel.txt" 
...
def loadData():
    ...
    dataMat=np.mat(np.zeros((numcase,dd)))  #n x 100x100
    ###########
    i=0
